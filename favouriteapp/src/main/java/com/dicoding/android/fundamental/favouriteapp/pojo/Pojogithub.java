package com.dicoding.android.fundamental.favouriteapp.pojo;

import android.database.Cursor;
import android.os.Parcelable;

import com.dicoding.android.fundamental.favouriteapp.Database.dbContract;
import com.google.gson.annotations.SerializedName;

import java.util.List;

import static com.dicoding.android.fundamental.favouriteapp.Database.dbContract.getFavoriteItem;
...
//    private String username,name,company,location,repository,follower,following;
    ...
    public Pojogithub (Cursor c){
        this.id = c.getInt(0);
        this.username = getFavoriteItem(c, dbContract.UserColumns.USERNAME);
        this.ivprofil = getFavoriteItem(c,dbContract.UserColumns.AVATAR);
    }
